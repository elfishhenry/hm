...
script_dir = r"C:\Users\User\Documents\lets try making a bot again\hm\pythonbotcommands"
cog_dir = r"C:\Users\User\Documents\lets try making a bot again\hm"
log_file = os.path.join(script_dir, 'bot.log')

#non cog commands running
...
def run_cogs():
    script_path = os.path.join(cog_dir, 'main.py')
    subprocess.run(["python", script_path])
...
if __name__ == "__main__":
    try:
        ...
        p3 = multiprocessing.Process(target=run_cogs)       
